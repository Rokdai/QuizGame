          ...
          <View>
            ...
            <ButtonContainer>
              <Button
                ...
                onPress={() =>
                  this.answer(question.answer_1, question.correct_answer)
                }
              />
              <Button
                key={2}
                ...
                onPress={() =>
                  this.answer(question.answer_2, question.correct_answer)
                }
              />
              <Button
                key={3}
                ...
                onPress={() =>
                  this.answer(question.answer_3, question.correct_answer)
                }
              />
              <Button
                key={4}
                ...
                onPress={() =>
                  this.answer(question.answer_4, question.correct_answer)
                }
              />
            </ButtonContainer>
          </View>
